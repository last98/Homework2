function display2_1() {
  var myanswer  = "My answer goes here: The first console.log statement would return undefined since dragonball isn't an element of saiyan. The 2nd statement would return true since null and undefined have the same values. However, for the 3rd statement 'false' is returned because null and undefined are not the same things." // TODO 2.1: Fill in Answer here after the :
  document.getElementById("21answer").innerHTML = myanswer; // Do not change
}
function display2_2() {
  var myanswer  = "My answer goes here: This will make JS go into strict mode. The statement would throw an error because the variable, x is not declared before x is defined. " // TODO 2.2: Fill in Answer here
  document.getElementById("22answer").innerHTML = myanswer; // Do not change
}

function display2_5() {
  var myanswer  = "My answer goes here: The children can be seen but not on the HTML page because they are elements of a tag, not their own property." // TODO 2.5: Fill in Answer here
