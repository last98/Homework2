function openModal() {
    ...
    confirmMyInput.onkeyup = function() {
                ...
                var passEqualsConfPass = (myInput.length == confirmMyInput.length && myInput.value == confirmMyInput.value); // TODO: Change this to the condition that needs to be checked so that the text entered in password equals the text in confirm password
...
function enableButton(letter, capital, number, length, match) {
    ...
    var condition = (letter.classList.length==1 && letter.classList[0]=="valid" && capital.classList.length==1 && capital.classList[0]=="valid" && number.classList.length==1 && number.classList[0]=="valid" && length.classList.length==1 && length.classList[0]=="valid" && match.classList.length==1 && match.classList[0]=="valid"); // TODO: Replace false with the correct condition
    if(condition) {       
